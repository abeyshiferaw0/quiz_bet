...
class DialogGameConfirmation extends StatefulWidget {
  const DialogGameConfirmation(
      {Key? key,
  ...
  @override
  State<DialogGameConfirmation> createState() => _DialogGameConfirmationState();
}

class _DialogGameConfirmationState extends State<DialogGameConfirmation> {
  @override
  void initState() {
    super.initState();
  }
